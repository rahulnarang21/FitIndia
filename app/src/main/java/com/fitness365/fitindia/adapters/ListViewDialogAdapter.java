...
public class ListViewDialogAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        Typeface fontRegular = Typeface.createFromAsset(context.getResources().getAssets(),
                "fonts/Barlow-Regular.ttf");
        viewHolder.listItemTitle.setTypeface(fontRegular);
        viewHolder.listItemSubtitle.setTypeface(fontRegular);
